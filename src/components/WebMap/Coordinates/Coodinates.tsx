  ...
  return <div id="coordinatesWidget">
    ...
    <div  hidden={showSearch ? undefined : true}>
      ...
      <CalciteInput scale="s" ref={y} hidden={['dd', 'spft', 'dms'].includes(selectedFormat) ? undefined : true}  id="ycoord"
        placeholder={selectedFormat === 'dd' ? '35.7582196' : selectedFormat === 'spft' ? '731166.165' : selectedFormat === 'dms' ? `35° 45' 29.7116777"` : ''}      
      ></CalciteInput>
      ...
      <CalciteLabel scale="s">
        ...
        placeholder={selectedFormat === 'dd' ? '-78.8079653' : selectedFormat === 'spft' ? '2056872.973' : selectedFormat === 'dms' ? `-78° 48' 31.524"`:'' }
        ></CalciteInput>
